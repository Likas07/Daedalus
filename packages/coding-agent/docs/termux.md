...
Daedalus runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
Create `~/.daedalus/agent/AGENTS.md` to help the agent understand the Termux environment:
