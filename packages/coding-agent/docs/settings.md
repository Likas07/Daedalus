...
| `.daedalus/settings.json` | Project (current directory) |
...
Project settings (`.daedalus/settings.json`) override global settings. Nested objects are merged:

```json
// ~/.daedalus/agent/settings.json (global)
{
  "theme": "dark",
  "compaction": { "enabled": true, "reserveTokens": 16384 }
}

// .daedalus/settings.json (project)
{
