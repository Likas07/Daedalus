...
Play DOOM as an overlay in Daedalus. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
daedalus --extension ./examples/extensions/doom-overlay
```
...
- The upstream overlay integration that this Daedalus example was adapted from.
