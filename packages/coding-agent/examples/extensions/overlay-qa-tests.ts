...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@daedalus-pi/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@daedalus-pi/tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@daedalus-pi/tui";
