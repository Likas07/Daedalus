 ...
 * Encodes cwd into a safe directory name under ~/.daedalus/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.daedalus/agent/sessions/<encoded-cwd>/).
	 */
