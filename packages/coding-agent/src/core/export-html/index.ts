...
import { HLJS_JS, MARKED_JS, TEMPLATE_CSS, TEMPLATE_HTML, TEMPLATE_JS } from "./template.generated.js";
...
function generateHtml(sessionData: SessionData, themeName?: string): string {
	...
	const templateCss = TEMPLATE_CSS;
	const templateJs = TEMPLATE_JS;
	const markedJs = MARKED_JS;
	const hljsJs = HLJS_JS;
...
const BUILTIN_TOOLS = new Set(["bash", "read", "write", "edit", "hashline_edit", "ls", "find", "grep"]);
