...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@daedalus-pi/tui";
...
export function getAvailableThemesWithPaths(): ThemeInfo[] {
	...
	// Built-in themes (embedded, no filesystem path)
...
const THEME_KEY = Symbol.for("@daedalus-pi/coding-agent:theme");
...
export function getSettingsListTheme(): import("@daedalus-pi/tui").SettingsListTheme {
	return {
