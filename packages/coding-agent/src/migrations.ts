...
/**
 * Migrate sessions from ~/.daedalus/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.daedalus/agent/ instead of
 * ~/.daedalus/agent/sessions/<encoded-cwd>/. This migration moves them
