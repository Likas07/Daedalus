# @daedalus-pi/agent-core

Stateful agent with tool execution and event streaming. Built on `@daedalus-pi/ai`.
...
```typescript
import { Agent, streamProxy } from "@daedalus-pi/agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@daedalus-pi/agent-core";
