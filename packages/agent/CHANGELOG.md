...
- **Agent loop moved from `@daedalus-pi/ai`**: The `agentLoop`, `agentLoopContinue`, and related types have moved to this package. Import from `@daedalus-pi/agent-core` instead.
