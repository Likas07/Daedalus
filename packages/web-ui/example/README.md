# Daedalus Web UI - Example

This is a minimal example showing how to use `@daedalus-pi/web-ui` in a web application.
...
- [Daedalus Web UI Documentation](../README.md)
- [Daedalus AI Documentation](../../ai/README.md)
