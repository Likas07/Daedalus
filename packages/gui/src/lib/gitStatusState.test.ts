...
import { getGitStatusSnapshot, refreshGitStatus, resetGitStatusStateForTests, watchGitStatus } from "./gitStatusState";
...
vi.mock("../environments/runtime/service", () => ({
	readEnvironmentConnection: (environmentId: string) => serviceHarness.connections.get(environmentId) ?? null,
