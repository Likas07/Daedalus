...
describe("projectPaths", () => {
	...
	it("resolves explicit relative paths against the current project", () => {
		...
		expect(resolveProjectPathForDispatch("./docs", "/home/user\\project")).toBe("/home/user\\project/docs");
	});
	...
	it("navigates browse paths with matching separators", () => {
		...
		expect(appendBrowsePathSegment("/home/user\\project/", "docs")).toBe("/home/user\\project/docs/");
