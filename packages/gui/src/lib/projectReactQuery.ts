...
export const projectQueryKeys = {
	...
	searchEntries: (environmentId: EnvironmentId | null, cwd: string | null, query: string, limit: number) =>
...
export function projectSearchEntriesQueryOptions(input: {
	...
	return queryOptions({
		...
		enabled: (input.enabled ?? true) && input.environmentId !== null && input.cwd !== null && input.query.length > 0,
