...
function ChatThreadRouteView() {
	...
	const draftThread = useComposerDraftStore((store) => (threadRef ? store.getDraftThreadByRef(threadRef) : null));
	...
	const hasOpenedDiff =
		diffPanelMountState.threadKey === currentThreadKey ? diffPanelMountState.hasOpenedDiff : diffOpen;
