...
import { AnchoredToastProvider, stackedThreadToast, ToastProvider, toastManager } from "../components/ui/toast";
import {
...
import { deriveLogicalProjectKeyFromSettings, derivePhysicalProjectKeyFromPath } from "../logicalProject";
...
function EventRouter() {
	...
	const handleWelcome = useEffectEvent((payload: ServerLifecycleWelcomePayload | null) => {
		...
		void (async () => {
			...
			const bootstrapEnvironmentState = useStore.getState().environmentStateById[payload.environment.environmentId];
			const bootstrapProject = bootstrapEnvironmentState?.projectById[payload.bootstrapProjectId] ?? null;
			const bootstrapProjectKey =
				...
				(serverConfig?.cwd
					...
					: null) ??
				scopedProjectKey(scopeProjectRef(payload.environment.environmentId, payload.bootstrapProjectId));
	...
	const handleServerConfigUpdated = useEffectEvent((notification: ServerConfigUpdatedNotification | null) => {
