...
describe("expandCollapsedComposerCursor", () => {
	...
	it("maps collapsed skill cursor to expanded text cursor", () => {
		...
		expect(expandCollapsedComposerCursor(text, collapsedCursorAfterSkill)).toBe(expandedCursorAfterSkill);
	});
});
...
describe("collapseExpandedComposerCursor", () => {
	...
	it("maps expanded skill cursor back to collapsed cursor", () => {
		...
		expect(collapseExpandedComposerCursor(text, expandedCursorAfterSkill)).toBe(collapsedCursorAfterSkill);
	});
});
