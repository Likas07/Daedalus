...
import { type DraftThreadEnvMode, type DraftThreadState, useComposerDraftStore } from "../composerDraftStore";
		...
		(
			...
			if (storedDraftThread) {
				return (async () => {
					...
					if (currentRouteTarget?.kind === "draft" && currentRouteTarget.draftId === storedDraftThread.draftId) {
						return;
					}
