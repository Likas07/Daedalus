...
export class TerminalCwdError extends Schema.TaggedErrorClass<TerminalCwdError>()("TerminalCwdError", {
	cwd: Schema.String,
	...
	override get message() {
		...
		const causeMessage =
			this.cause && typeof this.cause === "object" && "message" in this.cause ? this.cause.message : undefined;
		return causeMessage
...
export class TerminalHistoryError extends Schema.TaggedErrorClass<TerminalHistoryError>()("TerminalHistoryError", {
