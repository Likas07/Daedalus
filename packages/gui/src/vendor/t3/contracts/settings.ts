...
import { DEFAULT_GIT_TEXT_GENERATION_MODEL_BY_PROVIDER, ProviderOptionSelections } from "./model.ts";
...
export const SidebarProjectGroupingMode = Schema.Literals(["repository", "repository_path", "separate"]);
...
export const ClientSettingsSchema = Schema.Struct({
	...
	sidebarProjectGroupingOverrides: Schema.Record(TrimmedNonEmptyString, SidebarProjectGroupingMode).pipe(
...
export class ServerSettingsError extends Schema.TaggedErrorClass<ServerSettingsError>()("ServerSettingsError", {
