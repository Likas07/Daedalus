...
export const ProviderOptionDescriptor = Schema.Union([SelectProviderOptionDescriptor, BooleanProviderOptionDescriptor]);
...
function coerceLegacyOptionsObjectToArray(record: Record<string, unknown>): ReadonlyArray<ProviderOptionSelection> {
