...
function cloneDescriptor(descriptor: ProviderOptionDescriptor): ProviderOptionDescriptor {
	return descriptor.type === "select"
		? {
				...
				...(descriptor.promptInjectedValues ? { promptInjectedValues: [...descriptor.promptInjectedValues] } : {}),
			}
		: { ...descriptor };
}
...
export function getProviderOptionCurrentLabel(
	...
	if (descriptor.type === "boolean") {
		return typeof descriptor.currentValue === "boolean" ? (descriptor.currentValue ? "On" : "Off") : undefined;
	}
...
export function normalizeModelSlug(model: string | null | undefined, provider: ProviderKind = "codex"): string | null {
	...
	const aliased = Object.hasOwn(aliases, trimmed) ? aliases[trimmed] : undefined;
...
export function resolveModelSlugForProvider(provider: ProviderKind, model: string | null | undefined): string {
...
function cloneSelections(selections: ReadonlyArray<ProviderOptionSelection>): Array<ProviderOptionSelection> {
