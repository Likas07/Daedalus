...
export function parsePersistedServerObservabilitySettings(raw: string): PersistedServerObservabilitySettings {
	try {
 ...
 */
export function applyServerSettingsPatch(current: ServerSettings, patch: ServerSettingsPatch): ServerSettings {
