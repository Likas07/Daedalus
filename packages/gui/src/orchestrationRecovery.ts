export type OrchestrationRecoveryReason = "bootstrap" | "sequence-gap" | "resubscribe" | "replay-failed";
...
export function createOrchestrationRecoveryCoordinator() {
	...
	return {
		...
		completeReplayRecovery(): ReplayRecoveryCompletion {
			const replayMadeProgress = replayStartSequence !== null && state.latestSequence > replayStartSequence;
