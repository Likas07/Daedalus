...
function getTimestampFormatter(timestampFormat: TimestampFormat, includeSeconds: boolean): Intl.DateTimeFormat {
	...
	const formatter = new Intl.DateTimeFormat(undefined, getTimestampFormatOptions(timestampFormat, includeSeconds));
