...
function ScriptIcon({ icon, className = "size-3.5" }: { icon: ProjectScriptIcon; className?: string }) {
			...
			{primaryScript ? (
				<Group aria-label="Project scripts">
					...
					<Menu highlightItemOnHover={false}>
						<MenuTrigger render={<Button size="icon-xs" variant="outline" aria-label="Script actions" />}>
				...
				<Button size="xs" variant="outline" onClick={openAddDialog} title="Add action">
					...
					<span className="sr-only @3xl/header-actions:not-sr-only @3xl/header-actions:ml-0.5">Add action</span>
				</Button>
			)}
