...
export function buildGitActionProgressStages(input: {
	...
	const prStages = ["Preparing PR...", "Generating PR content...", "Creating GitHub pull request..."];
...
export function requiresDefaultBranchConfirmation(action: GitStackedAction, isDefaultBranch: boolean): boolean {
...
export function resolveThreadBranchUpdate(result: GitRunStackedActionResult): { branch: string } | null {
