...
export const OpenInPicker = memo(function OpenInPicker({
	...
	const options = useMemo(() => resolveOptions(navigator.platform, availableEditors), [availableEditors]);
	...
	return (
		<Group aria-label="Subscription actions">
			...
			>
				...
				<span className="sr-only @3xl/header-actions:not-sr-only @3xl/header-actions:ml-0.5">Open</span>
			</Button>
