...
function scoreModelPickerSearchToken(field: string, token: string, fieldBase: number): number | null {
...
export function buildModelPickerSearchText(model: ModelPickerSearchableModel): string {
	return normalizeSearchQuery(
		[model.name, model.shortName, model.subProvider, model.provider, PROVIDER_DISPLAY_NAMES[model.provider]]
