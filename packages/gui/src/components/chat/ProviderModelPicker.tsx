import type { ProviderKind, ResolvedKeybindingsConfig, ServerProvider } from "@t3tools/contracts";
...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
	...
	const selectedModel =
		selectedProviderOptions.find((option) => option.slug === props.model) ?? selectedProviderOptions[0];
	...
	return (
		...
		>
			...
			>
				...
				>
					<ProviderIcon aria-hidden="true" className={cn("size-4 shrink-0", props.activeProviderIconClassName)} />
					<Tooltip>
						<TooltipTrigger
							render={
								<span
