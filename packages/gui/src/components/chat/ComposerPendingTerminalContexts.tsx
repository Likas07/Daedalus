import { formatTerminalContextLabel, isTerminalContextExpired, type TerminalContextDraft } from "~/lib/terminalContext";
...
export function ComposerPendingTerminalContextChip({ context }: ComposerPendingTerminalContextChipProps) {
