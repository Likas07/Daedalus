	...
	return (
		<div className="flex flex-col w-12 border-r bg-muted/30  p-1 overflow-y-auto gap-1">
			...
			{AVAILABLE_PROVIDER_OPTIONS.map((option) => {
				...
				const liveProvider = props.providers ? getProviderSnapshot(props.providers, option.value) : undefined;
				...
				const trigger = isDisabled ? <span className="relative block w-full">{button}</span> : button;
