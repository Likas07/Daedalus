...
export const CursorIcon: Icon = ({ className, ...props }) => (
	<svg {...props} viewBox="0 0 466.73 532.09" className={cn("fill-[#26251E] dark:fill-[#EDECEC]", className)}>
...
export const VSCodium: Icon = (props) => {
	...
	return (
		<svg {...props} viewBox="0 0 100 100">
			<defs>
				<linearGradient id={gradientId} x1="0" x2="100" y1="0" y2="100" gradientUnits="userSpaceOnUse">
...
export const ClaudeAI: Icon = ({ className, ...props }) => (
	<svg {...props} preserveAspectRatio="xMidYMid" viewBox="0 0 256 257" className={cn("fill-[#d97757]", className)}>
...
export const IntelliJIdeaIcon: Icon = (props) => {
	...
	return (
		<svg {...props} viewBox="0 0 70 70" fill="none">
			...
			<path d="M70 18.7 68.7 59.2 41.8 70 25.6 59.6 49.3 35 38.9 12.3 48.2 1.1Z" fill={`url(#${gradientBId})`} />
