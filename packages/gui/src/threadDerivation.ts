...
function selectThreadProposedPlans(state: EnvironmentState, threadId: ThreadId): Thread["proposedPlans"] {
	return collectByIds(
...
function selectThreadTurnDiffSummaries(state: EnvironmentState, threadId: ThreadId): Thread["turnDiffSummaries"] {
	return collectByIds(
...
export function getThreadFromEnvironmentState(state: EnvironmentState, threadId: ThreadId): Thread | undefined {
